...
from restaurant import views as cancel_booking
...
urlpatterns = [
    ...
    path('<booking_id>cancel/', restaurant_views.cancel_booking, name='cancel'),
    path('amend/', restaurant_views.amend_booking, name='amend'),
